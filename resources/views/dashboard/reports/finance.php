...
<section class="card">
    ...
    <form method="get" action="<?= base_url('staff/dashboard/reports/finance'); ?>" class="finance-filters" id="report-filter-form">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('clear-filters')?.addEventListener('click', function() {
        window.location.href = '<?= base_url('staff/dashboard/reports/finance'); ?>';
    });
