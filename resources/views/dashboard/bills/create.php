...
<section class="card">
    <header class="page-header">
        <div>
            <a href="<?= base_url('staff/dashboard/bills'); ?>" class="back-link">
            ...
            <h2>Add New Bill</h2>
            <p class="page-subtitle">Record a new supplier bill or invoice</p>
        </div>
    </header>
    ...
    <form method="post" action="<?= base_url('staff/dashboard/bills/create'); ?>" class="bill-form">
        <div class="form-section">
            <h3 class="section-title">Bill Details</h3>
            <div class="form-grid">
                <label class="form-group required">
                    <span>Supplier</span>
                    <select name="supplier_id" id="supplier-select" required class="modern-select">
                    ...
                    <small style="color: #64748b; font-size: 0.875rem; margin-top: 0.25rem;">Select the supplier who issued this bill</small>
                </label>
                <label class="form-group required">
                    <span>Bill Reference / Invoice Number</span>
                    <input type="text" name="bill_reference" required class="modern-input" placeholder="INV-2025-001">
                    <small style="color: #64748b; font-size: 0.875rem; margin-top: 0.25rem;">Invoice or bill number from supplier</small>
                </label>
                <label class="form-group required">
                    <span>Description</span>
                    <textarea name="description" required class="modern-input" rows="3" placeholder="Describe the bill or invoice"></textarea>
                </label>
                <label class="form-group required">
        ...
        <div class="form-section">
            <h3 class="section-title">Recurring Bill</h3>
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <label class="form-group full-width">
                    <span>Notes</span>
                    <textarea name="notes" class="modern-input" rows="4" placeholder="Additional notes about this bill"></textarea>
                </label>
            </div>
        </div>

        <div class="form-actions">
            <a href="<?= base_url('staff/dashboard/bills'); ?>" class="btn btn-outline">Cancel</a>
